...
notifyWitness:
	...
	// write directly to main. In transaction-based shared main, beads data
	// is already visible on main — no Dolt branch merge needed.
	os.Unsetenv("BD_BRANCH")

	// Nudge refinery — MR bead is already visible on main (transaction-based writes).
	if mrID != "" {
